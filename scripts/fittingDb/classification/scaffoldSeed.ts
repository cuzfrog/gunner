...
export const OUT_OF_SCOPE_ATTRIBUTE_IDS: ReadonlySet<number> = new Set([
  20, 21, 38, 55, 67, 68, 77, 83, 84, 90, 97, 103, 104, 105, 126, 306, 552, 669, 714, 763, 796, 983, 1045, 1131, 1164, 1267, 1270, 1795, 1945, 2044, 3115,
  109, 110, 111, 113,
  142, 150, 153, 600,
  ...
  902,
  126,
  2621, 2622, 2733, 5727, 5728, 5734, 5743, 5744,
  1267,
  552,
  1544, 978,
  20,
