...
const SHIELD_BOOST_MULTIPLIER = 548;
const REPAIR_BONUS = 806;
const DURATION_SKILL_BONUS = 312;
const RECHARGE_RATE_BONUS = 338;
...
const BUILDER_INPUT_ATTRS = new Set<number>([
  ...
  SHIELD_BOOST_MULTIPLIER,
  REPAIR_BONUS,
  DURATION_SKILL_BONUS,
  RECHARGE_RATE_BONUS,
  ...SHIELD_RESONANCE_ATTRS,
  ...ARMOR_RESONANCE_ATTRS,
  ...HULL_RESONANCE_ATTRS,
