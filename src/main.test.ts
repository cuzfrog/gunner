...
const TAG_BY_ID: Record<string, string> = {
  ...
  "ship-b-ammo-all-list": "UL",
  "ship-b-ammo-all-section": "DIV",
  "ship-b-ammo-cargo-label": "SPAN",
  "ship-b-ammo-cargo-list": "UL",
  "ship-b-ammo-expand": "BUTTON",
  "ship-b-ammo-field": "DIV",
  "ship-b-ammo-popup": "DIV",
  "ship-b-ammo-summary": "SPAN",
  "ship-b-ammo-summary-icon": "IMG",
  "ship-b-ammo-trigger": "BUTTON",
  ...
  "ship-a-speed": "INPUT",
  "ship-a-tracking": "INPUT",
  "ship-a-optimal": "INPUT",
  "ship-a-falloff": "INPUT",
  "ship-b-tracking": "INPUT",
  "ship-b-optimal": "INPUT",
  "ship-b-falloff": "INPUT",
  "auto-zoom": "INPUT",
  ...
  "share-status": "SPAN",
  "ship-a-sig-res-options": "DIV",
  "ship-b-sig-res-options": "DIV",
  "sim-speed": "SELECT",
  "slide-hints": "SPAN",
