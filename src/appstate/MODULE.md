...
`userSettings.ts` was relaxed again to export `deactivatePropulsion`, the canonical propulsion-off summary shape shared by the live propulsion toggle, the session restore, and the fitting-basis rebuild; `index.ts` re-exports it.
