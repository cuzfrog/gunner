...
export class PropulsionVariantSection {
  ...
  constructor({ panel, els, fittingImport, imageCatalog }: { panel: SidePanel; els: PropulsionVariantSectionEls; fittingImport: FittingImport; imageCatalog: ImageCatalog }) {
    this.panel = panel;
    this.els = els;
