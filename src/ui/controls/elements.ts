...
export function createControlsEls() {
  return {
    ...
    attackerSpeedReadout: el("effective-attacker-speed"),
    targetSpeedReadout: el("effective-target-speed"),
    ...
    attackerEwarField: el("attacker-ewar-field"),
    ...
    attackerBoosterField: el("attacker-booster-field"),
    attackerBoosterTrigger: elOf("attacker-booster-trigger", isHtmlButtonElement),
    attackerBoosterPopup: el("attacker-booster-popup"),
    attackerBoosterSummary: el("attacker-booster-summary"),
    ...
    targetEwarField: el("target-ewar-field"),
    ...
    targetBoosterField: el("target-booster-field"),
    targetBoosterTrigger: elOf("target-booster-trigger", isHtmlButtonElement),
    targetBoosterPopup: el("target-booster-popup"),
    targetBoosterSummary: el("target-booster-summary"),
