...
function createGlobalControlsEls(): GlobalControlsEls {
  return {
    ...
    resApplicationA: el(globalElementId("resApplicationA")),
    ...
    resApplicationB: el(globalElementId("resApplicationB")),
    ...
    resApplicationLabelA: el(globalElementId("resApplicationLabelA")),
    ...
    resApplicationLabelB: el(globalElementId("resApplicationLabelB")),
