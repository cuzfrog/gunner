...
export function createControlsEls() {
  return {
    ...
    attackerEwarSection: el("attacker-ewar-section"),
    attackerEwarSummary: el("attacker-ewar-summary"),
    attackerBoosterSection: el("attacker-booster-section"),
    ...
    targetEwarSection: el("target-ewar-section"),
    targetEwarSummary: el("target-ewar-summary"),
    targetBoosterSection: el("target-booster-section"),
