...
function collectReadoutEls(els: ControlsElements): ReadoutEls {
  return {
    ...
    shipA: {
      ...
      resLockStateLabel: els.resLockStateLabelA,
      resAppliedDpsLabel: els.resAppliedDpsLabelA,
      resActualDpsLabel: els.resActualDpsLabelA,
    ...
    shipB: {
      ...
      resLockStateLabel: els.resLockStateLabelB,
      resAppliedDpsLabel: els.resAppliedDpsLabelB,
      resActualDpsLabel: els.resActualDpsLabelB,
