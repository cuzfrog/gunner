...
const GLOBAL_ELEMENT_DEFINITIONS = {
  ...
  resApplicationA: { id: "res-application-a", tag: "SPAN" as const, defaultValue: undefined },
  ...
  resApplicationB: { id: "res-application-b", tag: "SPAN" as const, defaultValue: undefined },
  ...
  resApplicationLabelA: { id: "res-application-label-a", tag: "SPAN" as const, defaultValue: undefined },
  ...
  resApplicationLabelB: { id: "res-application-label-b", tag: "SPAN" as const, defaultValue: undefined },
