...
const GLOBAL_ELEMENT_DEFINITIONS = {
  ...
  hpValueNone: { id: "hp-value-none", tag: "BUTTON" as const, defaultValue: undefined },
  hpValuePercentage: { id: "hp-value-percentage", tag: "BUTTON" as const, defaultValue: undefined },
  hpValueAbsolute: { id: "hp-value-absolute", tag: "BUTTON" as const, defaultValue: undefined },
  ...
  resInflictedDpsA: { id: "res-inflicted-dps-a", tag: "SPAN" as const, defaultValue: undefined },
  ...
  resInflictedDpsB: { id: "res-inflicted-dps-b", tag: "SPAN" as const, defaultValue: undefined },
  ...
  resInflictedDpsLabelA: { id: "res-inflicted-dps-label-a", tag: "SPAN" as const, defaultValue: undefined },
  ...
  resInflictedDpsLabelB: { id: "res-inflicted-dps-label-b", tag: "SPAN" as const, defaultValue: undefined },
  resTimeToImpactLabelB: { id: "res-time-to-impact-label-b", tag: "SPAN" as const, defaultValue: undefined },
  resSideA: { id: "res-side-a", tag: "DIV" as const, defaultValue: undefined },
  resSideB: { id: "res-side-b", tag: "DIV" as const, defaultValue: undefined },
...
const COMBATANT_ELEMENT_DEFINITIONS = {
  ...
  turretVariantGear: { tag: "BUTTON" as const, baseId: "turret-variant-gear", defaultValue: undefined },
  turretVariants: { tag: "DIV" as const, baseId: "turret-variants", defaultValue: undefined },
  turretWeaponOverloadButton: { tag: "BUTTON" as const, baseId: "turret-weapon-overload-button", defaultValue: undefined },
  ...
  targetingSkills: { tag: "DIV" as const, baseId: "targeting-skills", defaultValue: undefined },
  ...
  capacitorField: { tag: "DIV" as const, baseId: "capacitor-field", defaultValue: undefined },
  capacitorTrigger: { tag: "BUTTON" as const, baseId: "capacitor-trigger", defaultValue: undefined },
  capacitorPopup: { tag: "DIV" as const, baseId: "capacitor-popup", defaultValue: undefined },
  capacitorSection: { tag: "DIV" as const, baseId: "capacitor-section", defaultValue: undefined },
  capacitorSummaryRow: { tag: "SPAN" as const, baseId: "capacitor-summary-row", defaultValue: undefined },
  capacitorSummary: { tag: "SPAN" as const, baseId: "capacitor-summary", defaultValue: undefined },
  targetingField: { tag: "DIV" as const, baseId: "targeting-field", defaultValue: undefined },
  targetingTrigger: { tag: "BUTTON" as const, baseId: "targeting-trigger", defaultValue: undefined },
  targetingPopup: { tag: "DIV" as const, baseId: "targeting-popup", defaultValue: undefined },
  targetingSection: { tag: "DIV" as const, baseId: "targeting-section", defaultValue: undefined },
  targetingSummaryRow: { tag: "SPAN" as const, baseId: "targeting-summary-row", defaultValue: undefined },
  targetingSummary: { tag: "SPAN" as const, baseId: "targeting-summary", defaultValue: undefined },
  ...
  weaponSystemFighter: { tag: "BUTTON" as const, baseId: "weapon-system-fighter", defaultValue: undefined },
  ...
  launcherVariantGear: { tag: "BUTTON" as const, baseId: "launcher-variant-gear", defaultValue: undefined },
  launcherVariants: { tag: "DIV" as const, baseId: "launcher-variants", defaultValue: undefined },
  launcherWeaponOverloadButton: { tag: "BUTTON" as const, baseId: "launcher-weapon-overload-button", defaultValue: undefined },
  ...
  droneAlive: { tag: "SPAN" as const, baseId: "drone-alive", defaultValue: undefined },
  ...
  droneLaunchAll: { tag: "BUTTON" as const, baseId: "drone-launch-all", defaultValue: undefined },
  droneRecallAll: { tag: "BUTTON" as const, baseId: "drone-recall-all", defaultValue: undefined },
  ...
  fighterPanel: { tag: "DIV" as const, baseId: "fighter-panel", defaultValue: undefined },
  fighterTrigger: { tag: "BUTTON" as const, baseId: "fighter-trigger", defaultValue: undefined },
  fighterSummary: { tag: "SPAN" as const, baseId: "fighter-summary", defaultValue: undefined },
  fighterSummaryIcon: { tag: "IMG" as const, baseId: "fighter-summary-icon", defaultValue: undefined },
  fighterPopup: { tag: "DIV" as const, baseId: "fighter-popup", defaultValue: undefined },
  fighterField: { tag: "DIV" as const, baseId: "fighter-field", defaultValue: undefined },
  fighterOptimal: { tag: "SPAN" as const, baseId: "fighter-optimal", defaultValue: undefined },
  fighterFalloff: { tag: "SPAN" as const, baseId: "fighter-falloff", defaultValue: undefined },
  fighterDamage: { tag: "SPAN" as const, baseId: "fighter-damage", defaultValue: undefined },
  fighterCycleTime: { tag: "SPAN" as const, baseId: "fighter-cycle-time", defaultValue: undefined },
  fighterMaxVelocity: { tag: "SPAN" as const, baseId: "fighter-max-velocity", defaultValue: undefined },
  fighterCount: { tag: "SPAN" as const, baseId: "fighter-count", defaultValue: undefined },
  fighterAlive: { tag: "SPAN" as const, baseId: "fighter-alive", defaultValue: undefined },
  fighterLoadoutSection: { tag: "DIV" as const, baseId: "fighter-loadout-section", defaultValue: undefined },
  fighterLoadoutList: { tag: "DIV" as const, baseId: "fighter-loadout-list", defaultValue: undefined },
  fighterLaunchAll: { tag: "BUTTON" as const, baseId: "fighter-launch-all", defaultValue: undefined },
  fighterRecallAll: { tag: "BUTTON" as const, baseId: "fighter-recall-all", defaultValue: undefined },
  fighterSummaryBar: { tag: "DIV" as const, baseId: "fighter-summary-bar", defaultValue: undefined },
  fighterSummarySquadrons: { tag: "SPAN" as const, baseId: "fighter-summary-squadrons", defaultValue: undefined },
  fighterSummaryCount: { tag: "SPAN" as const, baseId: "fighter-summary-count", defaultValue: undefined },
  fighterSummaryHangar: { tag: "SPAN" as const, baseId: "fighter-summary-hangar", defaultValue: undefined },
  fighterCatalogSection: { tag: "DIV" as const, baseId: "fighter-catalog-section", defaultValue: undefined },
  fighterCatalogLight: { tag: "UL" as const, baseId: "fighter-catalog-light", defaultValue: undefined },
  fighterCatalogHeavy: { tag: "UL" as const, baseId: "fighter-catalog-heavy", defaultValue: undefined },
  fighterCatalogSupport: { tag: "UL" as const, baseId: "fighter-catalog-support", defaultValue: undefined },
