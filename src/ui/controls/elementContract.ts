...
const GLOBAL_ELEMENT_DEFINITIONS = {
  ...
  newProfileCancel: { id: "new-profile-cancel", tag: "BUTTON" as const, defaultValue: undefined },
  ...
  resTransversal: { id: "res-transversal", tag: "SPAN" as const, defaultValue: undefined },
  resAngular: { id: "res-angular", tag: "SPAN" as const, defaultValue: undefined },
  resRadial: { id: "res-radial", tag: "SPAN" as const, defaultValue: undefined },
...
const COMBATANT_ELEMENT_DEFINITIONS = {
  ...
  shipImage: { tag: "IMG" as const, baseId: "ship-image", defaultValue: undefined },
  ...
  fittingTrigger: { tag: "BUTTON" as const, baseId: "fitting-trigger", defaultValue: undefined },
  fittingEye: { tag: "BUTTON" as const, baseId: "fitting-eye", defaultValue: undefined },
  fittingPopup: { tag: "DIV" as const, baseId: "fitting-popup", defaultValue: undefined },
