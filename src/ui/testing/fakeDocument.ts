...
const SELECT_IDS = new Set(["sigRes", "attacker-mode", "target-mode", "attacker-skills", "target-skills", "attacker-propulsion", "target-propulsion", "sim-speed"]);
...
const BUTTON_IDS = new Set(["play", "reset", "profile-save", "profile-select-trigger", "profile-delete", "profile-new", "new-profile-confirm", "new-profile-cancel", "share-link", "share-copy-url", "share-copy-text", "import-profile", "import-side-attacker", "import-side-target", "attacker-import-fitting", "target-import-fitting", "attacker-fitting-trigger", "attacker-fitting-eye", "target-fitting-trigger", "target-fitting-eye", "attacker-ammo-trigger", "attacker-ammo-expand", "attacker-propulsion-gear", "target-propulsion-gear", "attacker-skill-trigger", "target-skill-trigger", "attacker-overload-button", "target-overload-button", "attacker-ewar-trigger", "target-ewar-trigger", "attacker-booster-trigger", "target-booster-trigger", "tracking-unit-rad", "tracking-unit-score", "lang-en", "lang-zh", "lang-ja", "confirm-ok", "confirm-cancel"]);
