...
const BUTTON_IDS = new Set(["play", "reset", "canvas-settings-trigger", "profile-save", "profile-select-trigger", "profile-delete", "profile-new", "new-profile-confirm", "new-profile-save-current", "new-profile-clear-session", "share-link", "share-copy-url", "share-copy-text", "import-profile", "import-side-ship-a", "import-side-ship-b", "ship-a-import-fitting", "ship-b-import-fitting", "ship-a-ship-select-trigger", "ship-a-fitting-eye", "ship-b-ship-select-trigger", "ship-b-fitting-eye", "ship-a-ammo-trigger", "ship-a-ammo-expand", "ship-b-ammo-trigger", "ship-b-ammo-expand", "ship-a-propulsion-gear", "ship-b-propulsion-gear", "ship-a-skill-trigger", "ship-b-skill-trigger", "ship-a-overload-button", "ship-b-overload-button", "ship-a-ewar-trigger", "ship-b-ewar-trigger", "ship-a-tracking-unit-rad", "ship-a-tracking-unit-score", "ship-b-tracking-unit-rad", "ship-b-tracking-unit-score", "lang-en", "lang-zh", "lang-ja", "confirm-ok", "confirm-cancel", "weapon-range-button", "ship-a-launcher-ammo-trigger", "ship-b-launcher-ammo-trigger", "ship-a-weapon-system-turret", "ship-a-weapon-system-missile", "ship-a-weapon-system-drone", "ship-b-weapon-system-turret", "ship-b-weapon-system-missile", "ship-b-weapon-system-drone", "ship-a-launcher-attributes-trigger", "ship-b-launcher-attributes-trigger", "ship-a-launcher-variant-gear", "ship-b-launcher-variant-gear", "ship-a-turret-variant-gear", "ship-b-turret-variant-gear"]);
