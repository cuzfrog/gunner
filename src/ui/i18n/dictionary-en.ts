...
export const EN: LanguageSlice<"en"> = {
  ...
  "ewar.hover.explosionRadius": { en: "Explosion radius" },
  "ewar.hover.explosionVelocity": { en: "Explosion velocity" },
  "ewar.hover.missileVelocity": { en: "Missile velocity" },
  "ewar.hover.flightTime": { en: "Flight time" },
