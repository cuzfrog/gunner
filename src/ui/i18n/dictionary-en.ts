...
export const EN: LanguageSlice<"en"> = {
  ...
  "label.weaponRange.both": { en: "Weapon range: both" },
  "label.weaponRange.shipA": { en: "Weapon range: Ship A" },
  "label.weaponRange.shipB": { en: "Weapon range: Ship B" },
  "label.weaponRange.none": { en: "Weapon range: off" },
  "label.zoom": { en: "Zoom" },
